...
const StudentVideo = (props) => {
  ...
  useEffect(() => {
    dragElement(document.getElementById("student-video"), props);
  }, [])

  useEffect(() => {
    const vid = document.getElementById('student-video');
  ...
  return (
    <div className="student-container">
      ...
      <div id="student-video" className="student-video-wrapper drag">
        Student Video
      </div>
    </div>
  )
